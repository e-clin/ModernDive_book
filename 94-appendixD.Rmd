...
If you look at the resulting `airline_safety_smaller_tidy` data frame in the spreadsheet viewer, you'll see that the variable `fatalities_years` has 2 possible values: `"fatalities_85_99", "fatalities_00_14" corresponding to the 2 columns of `airline_safety_smaller` we tidied. 
